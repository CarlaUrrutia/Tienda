...
class BoletaServiceImplTest {
    ...
    @Mock private BoletaRepository boletaRepository;
    ...
    @Test
    @DisplayName("getAllBoletas - retorna lista enriquecida")
    ...
    @Test
    @DisplayName("getBoletaById - lanza excepcion cuando no existe")
