...
public class ApiResponse<T> {
    ...
    @Schema(description = "Mensaje descriptivo del resultado", example = "Cliente creado exitosamente")
    ...
    public static <T> ApiResponse<T> ok(String message, T data, Map<String, String> links) {
        return ApiResponse.<T>builder()
                .status(200).success(true)
                .message(message).data(data).links(links)
                .build();
    }

    public static <T> ApiResponse<T> created(String message, T data, Map<String, String> links) {
        return ApiResponse.<T>builder()
    ...
    public static <T> ApiResponse<T> deleted(String message, Map<String, String> links) {
        return ApiResponse.<T>builder()
                .status(200).success(true)
                .message(message).links(links)
                .build();
    }
