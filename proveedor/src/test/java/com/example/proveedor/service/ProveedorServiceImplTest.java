...
class ProveedorServiceImplTest {
    ...
    @Test
    @DisplayName("getAllProveedores - retorna lista de proveedores")
    ...
    void getProveedorById_existente_retornaProveedor() {
    ...
    void getProveedorById_noExistente_retornaNull() {
    ...
    void updateProveedor_existente_actualiza() {
        Proveedor datosNuevos = new Proveedor(1, "Nuevo Proveedor", "nuevo@mail.com");
        when(proveedorRepository.buscarPorId(1)).thenReturn(List.of(proveedor));
        when(proveedorRepository.save(any(Proveedor.class))).thenAnswer(inv -> inv.getArgument(0));

        Proveedor resultado = proveedorService.updateProveedor(1, datosNuevos);
    ...
    void updateProveedor_noExistente_retornaNull() {
        when(proveedorRepository.buscarPorId(99)).thenReturn(List.of());
